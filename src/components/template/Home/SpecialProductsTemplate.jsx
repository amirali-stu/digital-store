...
function SpecialProductsTemplate() {
  return (
    ...
    <div className="col-span-1 h-[200px] group rounded-2xl transition-all border-l-0 hover:border-l-6 border-l-primary shadow-[0px_24px_48px_0px,_inset_0px_0px_0px_0px_#69BCF4] shadow-black/4 border border-[#F0F1F1] bg-white p-6 flex items-center gap-x-6">
      <img
      ...
      <div className="w-full flex flex-col gap-y-3">
        ...
        <p className="line-clamp-2 text-Neutral-700 leading-6">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <div className="py-2 flex items-end flex-col **:text-Neutral-800">
            <span>شروع از:</span>
            <p className="flex items-center font-sans-medium mt-2">
              118.000.000
