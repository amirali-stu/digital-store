...
export default function AmazingDiscountProduct() {
  return (
    <div className="relative w-[248px] h-[380px] rounded-2xl bg-white p-4 cursor-pointer transition-all duration-300 hover:-translate-y-3">
      <div>
      ...
      {/* offer */}
      <button className="text-white text-sm bg-[#C50000] rounded-xl flex-center p-3 gap-x-2 absolute hidden top-5 left-5">
        <p>فروش ویژه</p>
