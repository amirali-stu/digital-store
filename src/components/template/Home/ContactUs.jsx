  ...
  return (
    <section className="mb-40 second-container w-full">
      <div className="w-full relative z-20 h-[238px] bg-[#007AF4] border-5 drop-shadow-[0px_20px_40px] drop-shadow-black/10 border-white rounded-3xl flex items-center justify-between pl-10">
        ...
        <div className="bg-white/10 rounded-2xl w-[329px] h-[65px] flex-center flex-col gap-y-8">
        ...
        {/* social media */}
        <div className="w-[276px] h-[90px] bg-[#007AF4] border-5 border-t-2 border-white border-t-[#007AF4] absolute left-5 -bottom-22.5 social-media_contact-us -z-50 rounded-t-xl flex flex-row-reverse items-center gap-x-2 px-4 pb-4">
          <div
